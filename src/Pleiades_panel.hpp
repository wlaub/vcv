    ...
    input = Port::create<PJ301MPort>(
        Vec(240.362745,45.429099), Port::INPUT, module, Pleiades::INPUT_CLOCK
        );
    center(input,1,1);
    addInput(input);    
    ...
    input = Port::create<PJ301MPort>(
        Vec(87.6372525,45.429097), Port::INPUT, module, Pleiades::INPUT_ANALOG
        );
    center(input,1,1);
    addInput(input);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(163.999995,72.0), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+3
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(60.36812268943471,122.24161106769014), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+2
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(35.30944304481176,233.3724479082614), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+1
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(106.72794023571953,322.92817473240893), Port::OUTPUT, module, Pleiades::OUTPUT_OUT
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(267.6318836444233,122.2416232683049), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+4
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(292.69055682760586,233.37245373895388), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+5
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(221.27206326740173,322.9281749333919), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+6
        );
    center(output,1,1);
    addOutput(output);    
    ...
    output = Port::create<PJ301MPort>(
        Vec(302.1758432674017,313.0111349333919), Port::OUTPUT, module, Pleiades::OUTPUT_OUT+7
        );
    center(output,1,1);
    addOutput(output);    
