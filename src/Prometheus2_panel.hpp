    ...
    input = createInputCentered<PJ301MPort>(
        Vec(20.0,234.44), module, Prometheus2::INPUT_LENGTH_CV
        );
    addInput(input);    
    ...
    input = createInputCentered<PJ301MPort>(
        Vec(60.000000000000014,234.44), module, Prometheus2::INPUT_PARAM_0_CV
        );
    addInput(input);    
    ...
    addParam(createParamCentered<RoundTinyBlackKnob>(
        Vec(100.0, 101.12), 
        module, Prometheus2::PARAM_PARAM_1_FINE
    ));
